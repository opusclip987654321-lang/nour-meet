...
export function Dashboard() {
  ...
  // Profil pas encore validé : l'état de l'entretien donne le libellé du profil (un refus n'est pas
  // « à compléter ») et, sans aucune inscription, l'onglet d'arrivée est l'entretien — la prochaine étape.
  const validated=!!user?.profile?.validatedAt;
