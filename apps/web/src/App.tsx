...
const RestaurantOnboarding = lazyNamed(() => import("./pages/RestaurantOnboarding"), "RestaurantOnboarding");
const Restaurateurs = lazyNamed(() => import("./pages/Restaurateurs"), "Restaurateurs");
