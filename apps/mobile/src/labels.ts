...
export const EVENT_STATUS_LABEL: Record<string, string> = { DRAFT: "Brouillon", PENDING_REVIEW: "En attente de validation", PUBLISHED: "Publiée", FULL: "Complète", CANCELLED: "Annulée", COMPLETED: "Terminée" };
export const PAYMENT_STATUS_LABEL: Record<string, string> = { PENDING: "En attente", SUCCEEDED: "Payé", FAILED: "Échoué", REFUNDED: "Remboursé" };
